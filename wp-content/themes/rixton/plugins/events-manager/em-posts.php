...
function wp_events_plugin_init(){
	...
	if( get_option('dbem_tags_enabled', true) ){
		register_taxonomy(EM_TAXONOMY_TAG,array(EM_POST_TYPE_EVENT,'event-recurring'),array( 
			...
			'label' => __('Group Tags'),
			'singular_label' => __('Group Tag'),
			'labels' => array(
				'name'=>__('Group Tags','events-manager'),
				'singular_name'=>__('Group Tag','events-manager'),
				'search_items'=>__('Search Group Tags','events-manager'),
				'popular_items'=>__('Popular Group Tags','events-manager'),
				'all_items'=>__('All Group Tags','events-manager'),
				'parent_items'=>__('Parent Group Tags','events-manager'),
				'parent_item_colon'=>__('Parent Group Tag:','events-manager'),
				'edit_item'=>__('Edit Group Tag','events-manager'),
				'update_item'=>__('Update Group Tag','events-manager'),
				'add_new_item'=>__('Add New Group Tag','events-manager'),
				'new_item_name'=>__('New Group Tag Name','events-manager'),
				'separate_items_with_commas'=>__('Separate Group tags with commas','events-manager'),
				'add_or_remove_items'=>__('Add or remove events','events-manager'),
				'choose_from_the_most_used'=>__('Choose from most used Group tags','events-manager'),
			),
			'capabilities' => array(
