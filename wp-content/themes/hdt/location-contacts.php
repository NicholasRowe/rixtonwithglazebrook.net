	...
	if ($web || $tw || $fb) : ?>
		...
		<p>
			...
			<?php if (get_field('contact_twitter_page')) : ?>
				...
				<a href="http://<?php echo $twitter; ?>" target="_blank" class="social-link"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/x-logo.png" width="40" height="40" alt="x-logo" /></a>
			<?php endif; ?>
